...
const data = {
  ...
  "Philosophie": { "Tle": { "Notions": ["La liberté","La justice","La vérité","Le bonheur","La conscience","Le travail"] } },
  "Anglais": { "3e": { "Grammaire": ["Temps verbaux"], "Vocabulaire": ["Mots essentiels"], "Expression écrite": ["Rédaction courte"] }, "2nde": { "Grammaire": ["Temps verbaux"], "Vocabulaire": ["Mots avancés"], "Expression écrite": ["Rédaction"] }, "1re": { "Grammaire": ["Temps verbaux avancés"], "Vocabulaire": ["Mots complexes"], "Expression écrite": ["Rédaction structurée"] }, "Tle": { "Grammaire": ["Grammaire avancée"], "Vocabulaire": ["Mots spécialisés"], "Expression écrite": ["Analyse texte"] } },
  "Espagnol": { "3e": { "Grammaire": ["Temps verbaux"], "Vocabulaire": ["Mots essentiels"], "Expression écrite": ["Rédaction courte"] }, "2nde": { "Grammaire": ["Temps verbaux"], "Vocabulaire": ["Mots avancés"], "Expression écrite": ["Rédaction"] }, "1re": { "Grammaire": ["Temps verbaux avancés"], "Vocabulaire": ["Mots complexes"], "Expression écrite": ["Rédaction structurée"] }, "Tle": { "Grammaire": ["Grammaire avancée"], "Vocabulaire": ["Mots spécialisés"], "Expression écrite": ["Analyse texte"] } },
  "Allemand": { "3e": { "Grammaire": ["Temps verbaux"], "Vocabulaire": ["Mots essentiels"], "Expression écrite": ["Rédaction courte"] }, "2nde": { "Grammaire": ["Temps verbaux"], "Vocabulaire": ["Mots avancés"], "Expression écrite": ["Rédaction"] }, "1re": { "Grammaire": ["Temps verbaux avancés"], "Vocabulaire": ["Mots complexes"], "Expression écrite": ["Rédaction structurée"] }, "Tle": { "Grammaire": ["Grammaire avancée"], "Vocabulaire": ["Mots spécialisés"], "Expression écrite": ["Analyse texte"] } },
  "Technologie": { "3e": { "Informatique": ["Algorithmique","Programmation","Réseaux"], "Sciences industrielles": ["Électricité","Mécanique","Électronique"] } },
  "EMC": { "3e": { "Citoyenneté": ["Droits et devoirs","Laïcité","Égalité"], "Institutions": ["Fonctionnement de l'État","Europe"] }, "2nde": { "Citoyenneté": ["Droits et devoirs","Égalité"], "Institutions": ["Europe","ONU"] }, "1re": { "Citoyenneté": ["Débats et valeurs"], "Institutions": ["Gouvernance","Droits internationaux"] }, "Tle": { "Citoyenneté": ["Valeurs républicaines","Droits fondamentaux"], "Institutions": ["Organisations internationales"] } }
};
